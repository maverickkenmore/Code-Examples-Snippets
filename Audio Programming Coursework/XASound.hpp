/*
	file:	XASound.hpp
	Version:	2.2
	Date:	27th March 2014; April 2013; September 2012.
...
public:
	...
	//--- Query if sound is valid; has a source voice that can play back audio.
	//--- virtual since subclass may have different definition of validity.
	virtual inline bool IsValid() const { return GetSourceVoice() != nullptr; }
...
/* Version history.
=== 2.2
IsValid() amended to be virtual; allows subclass to have different interpretation of validity.
=== 2.0
